export const ui = {
    ...
    notificationHistoryBtn: document.getElementById('notification-history-btn'),
    notificationSettingsModal: document.getElementById('notification-settings-modal'),
    notificationSettingsContent: document.getElementById('notification-settings-content'),
    notificationHistoryModal: document.getElementById('notification-history-modal'),
    notificationHistoryContent: document.getElementById('notification-history-content'),
    notificationHistoryList: document.getElementById('notification-history-list'),
    bookingNotifications: document.getElementById('booking-notifications'),
    cancellationNotifications: document.getElementById('cancellation-notifications'),
    systemNotifications: document.getElementById('system-notifications'),
    notificationSound: document.getElementById('notification-sound'),
    saveNotificationSettings: document.getElementById('save-notification-settings'),
    cancelNotificationSettings: document.getElementById('cancel-notification-settings'),
    closeNotificationHistory: document.getElementById('close-notification-history'),
