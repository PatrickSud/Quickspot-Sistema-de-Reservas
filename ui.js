export const ui = {
    ...
    exportCustomBtn: document.getElementById('export-custom-btn'),
    includeStats: document.getElementById('include-stats'),
    includeCharts: document.getElementById('include-charts'),
    includeUsers: document.getElementById('include-users'),
    closeExportModal: document.getElementById('close-export-modal'),
    advancedExportBtn: document.getElementById('advanced-export-btn'),
    // Modal de Relatório Personalizado
    customReportModal: document.getElementById('custom-report-modal'),
    customReportContent: document.getElementById('custom-report-content'),
    customReportTitle: document.getElementById('custom-report-title'),
    customReportDescription: document.getElementById('custom-report-description'),
    ...
    sectionOccupancy: document.getElementById('section-occupancy'),
